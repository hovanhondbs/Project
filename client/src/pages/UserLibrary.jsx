      ...
      <main className="flex-1 p-8">
        ...
        <div className="p-8">
          ...
          <div className="flex border-b border-gray-300 mb-4">
            <div className="mr-6 pb-2 border-b-2 border-blue-600 font-semibold text-blue-600">Flashcard sets</div>
            <div className="mr-6 pb-2 text-gray-400 cursor-not-allowed">Practice tests</div>
            <div className="mr-6 pb-2 text-gray-400 cursor-not-allowed">Classes</div>
          </div>
